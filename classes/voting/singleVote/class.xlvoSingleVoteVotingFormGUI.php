...
require_once('./Customizing/global/plugins/Services/Repository/RepositoryObject/LiveVoting/classes/voting/singleVote/class.xlvoMultiLineInputGUI.php');
...
class xlvoSingleVoteVotingFormGUI extends xlvoVotingFormGUI {
	...
	public function fillForm() {
		if ($this->voting->getObjId() == $this->parent_gui->getObjId()) {
			...
			$this->options = $this->voting->getVotingOptions()->where(array(
