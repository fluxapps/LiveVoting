...
class ilLiveVotingOption{
	...
	function doCreate()
	{
		...
		$ilDB->manipulate("INSERT INTO rep_robj_xlvo_option ".
			"(id, data_id, title) VALUES (".
			$ilDB->quote($this->getId(), "integer").",".
			$ilDB->quote($this->getDataId(), "integer").",".
	...
	function doRead()
	{
		...
		$set = $ilDB->query("SELECT * FROM rep_robj_xlvo_option ".
	...
	function doUpdate()
	{
		...
		$ilDB->manipulate($up = "UPDATE rep_robj_xlvo_option SET ".
				" data_id = ".$ilDB->quote($this->getDataId(), "integer").",".
	...
	function doDelete()
	{
		...
		$ilDB->manipulate("DELETE FROM rep_robj_xlvo_option WHERE ".
